...
export const orbitCategories: OrbitCategory[] = [
  ...
  },
  {
    id: 'development',
    label: 'DEVELOPMENT',
    tools: ['AI coding assistants', 'GitHub Copilot', 'LLM APIs'],
    tint: 'var(--color-ai-violet)',
  },
  {
    id: 'research',
    label: 'RESEARCH',
    tools: ['AI research tools', 'AI document tools', 'AI knowledge systems'],
    tint: 'var(--color-ai-cyan)',
  },
  {
    id: 'creative',
    label: 'CREATIVE',
    tools: ['AI image tools', 'AI video tools', 'AI design tools', 'AI audio tools'],
    tint: 'var(--color-ai-magenta)',
  },
  {
    id: 'automation',
    label: 'AUTOMATION',
    tools: ['AI automation tools', 'Workflow automation', 'AI content systems'],
